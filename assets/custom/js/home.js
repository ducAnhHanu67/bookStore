                    ...
                    <div class="col-9 bg-white rounded-2 p-2 product-container rounded-3">
                        ...
                        <div class="d-flex flex-column align-items-center justify-content-between h-25">
                            ...
                            <p class="fw-bold text-success text-center">
                                <span style="text-decoration: line-through; color: #4c4c79;">
                            ...
                            <div class="w-100 d-flex justify-content-evenly">
                                <button class="btn btn-see-details hvr-pu-grow" onclick="getBookDetail('${book.type}_${book.id}')">See details</button>
                                <button type="button" class="btn btn-see-details hvr-grow-shadow w-25">
